...
/*
undefined symbol: _kcinth
undefined symbol: _s0handler
undefined symbol: _kfork
undefined symbol: _sinit
*/
...
main()
{
      ...
      printf("Welcome to the Edoardo's 460 Multitasking System\n");
      ...
      kfork("/bin/u1"); 
      //kfork("/bin/u1"); kfork("/bin/u1"); kfork("/bin/u1");
